          ...
          <div class=" fsBanner fsStyleAutoclear" id="fsEl_7">
            ...
            <section class="fsElement fsContainer inner-logo-multimedia" id="fsEl_1964" data-use-new="true">
              ...
              <div class="fsElementContent">
                ...
                <div class="fsElement fsContent header-multimedia-holder" id="fsEl_1966" data-use-new="true" data-manual-resource-scaling="true" style="background-image: url('images/prog8.jpg');">
                  <div class="fsElementContent">
                  </div>
                </div>
              </div>
                  ...
                  <div class="fsElementContent">
                    <nav>
                      <ul class="fsNavLevel1">
                        ...
                        <li class="fsNavCurrentPage"><a href="back_up_care.php">Back-Up Care and Emergency Care</a></li>
                  ...
                  <div class="fsElement fsContent" id="fsEl_1531" data-use-new="true">
                    <div class="fsElementContent">
                      <div class="side_img_cvr">
                        <img src="images/ebcsds.png" alt="">
                      </div>
                      <div class="side_img_cvr">
                        <img src="images/ecmsac.png" alt="">
                      </div>
                      <div class="side_img_cvr">
                        <img src="images/ecndscls.png" alt="">
                      </div>
                      <div class="side_img_cvr">
                        <img src="images/ecsnd.png" alt="">
                      </div>
                      <div class="side_img_cvr">
                        <img src="images/eklvs.png" alt="">
                      </div>
                      <div class="side_img_cvr">
                        <img src="images/evdclasc.png" alt="">
                      </div>
                    </div>
                  </div>
                </div>
