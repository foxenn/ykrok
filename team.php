      ...
      <div class=" fsBanner fsStyleAutoclear" id="fsEl_7">
        ...
        <section class="fsElement fsContainer inner-logo-multimedia" id="fsEl_1964" data-use-new="true">
          ...
          <div class="fsElementContent">
            ...
            <div class="fsElement fsContent header-multimedia-holder" id="fsEl_1966" data-use-new="true" data-manual-resource-scaling="true" style="background-image: url('images/team_image.jpg');    background-position-y: -222px;">
              <div class="fsElementContent">
              </div>
            </div>
          </div>
            ...
            <div class=" fsDiv fsStyleTwoThirds fsStyleAutoclear" id="fsEl_1154">
              <div class="fsElement fsContent" id="fsEl_1155" data-use-new="true">
                ...
                <div class="fsElementContent">
                  ...
                  <p>Collectively, the leadership team is accountable for the development, supervision and management of the YKROK programme for children, teachers and parents. </p>
