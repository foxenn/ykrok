          ...
          <div class=" fsBanner fsStyleAutoclear" id="fsEl_7">
            ...
            <section class="fsElement fsContainer inner-logo-multimedia" id="fsEl_1964" data-use-new="true">
              ...
              <div class="fsElementContent">
                ...
                <div class="fsElement fsContent header-multimedia-holder" id="fsEl_1966" data-use-new="true" data-manual-resource-scaling="true" style="background-image: url('images/prog9.jpg');">
                  <div class="fsElementContent">
                  </div>
                </div>
              </div>
                  ...
                  <div class="fsElementContent">
                    <nav>
                      <ul class="fsNavLevel1">
                        ...
                        <li class="fsNavCurrentPage"><a href="holiday_camp.php">Summer Camps & Care During School Holidays</a></li>
                      </ul>
                    </nav>
                  </div>
                </section>
                  ...
                  <div class="fsElement fsContent" id="fsEl_1531" data-use-new="true">
                    <div class="fsElementContent">
                      <div class="side_img_cvr">
                        <img src="images/rvnsldnvs.png" alt="">
                      </div>
                      <div class="side_img_cvr">
                        <img src="images/rvsdv.png" alt="">
                      </div>
                      <div class="side_img_cvr">
                        <img src="images/rvsk.png" alt="">
                      </div>
                    </div>
                  </div>
                </div>
