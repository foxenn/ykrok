                  ...
                  <div class="fsElementContent">
                    <nav>
                      <ul class="fsNavLevel1">
                        ...
                        <li class="fsNavCurrentPage"><a href="safety_procedures.php">Safety Procedures </a></li>
              ...
              <div class="fsPageLayout fsLayout fsTwoColumnWideLeftLayout fsStyleAutoclear" id="fsEl_1153" data-use-new="true">
                ...
                <div class=" fsDiv fsStyleTwoThirds fsStyleAutoclear" id="fsEl_1154">
                  <div class="fsElement fsContent" id="fsEl_1155" data-use-new="true">
                    <header>
                      <h2 class="fsElementTitle">Safety Procedures </h2>
                    </header>
                    <div class="fsElementContent">
                      <div class="WordSection1">
                        <p>
                          <strong style="color: rgb(192, 80, 77); text-transform: capitalize;"><span style="font-size: 18px;">Glass Walls and Half Walls .</span></strong>
                        </p>
                        <p>Your Kids ‘R’ Our Kids utilizes tempered, safety glass walls for our classrooms for a multitude of reasons. First, they provide the best view possible of ongoing child care. Secondly, they’re cleaner and safer and leave no question of who is caring for your children.</p>
                        <p>Glass walls promote an open environment, where teachers and children are in constant contact with one another. Any activity in a Your Kids ‘R’ Our Kids classroom is easily visible through these glass walls ensuring the utmost safety and security of everyone. Your child can also observe the teacher and activities in the next room - making her transition to the next class easier.</p>
                        <p>Our walls are tempered too, just like windshields. In the unlikely event they break, they’ll crumble, leaving no danger for infant child care, preschool or school-age kids.</p>
                        <p>We also have half walls for our classrooms. Our open plan lets the light shine in and your child’s face shine through.</p>
                      </div>
                    </div>
                  </div>
                </div>
