                  ...
                  <div class="fsElementContent">
                    <nav>
                      <ul class="fsNavLevel1">
                        ...
                        <li><a href="history.php">History of YKROK</a></li>
                        ...
                        <li class="fsNavCurrentPage"><a href="nurturing_environment.php">Nurturing Environment </a></li>
                        <li><a href="tie_up_solutions.php">Corporate Tie-Up</a></li>
              ...
              <div class="fsPageLayout fsLayout fsTwoColumnWideLeftLayout fsStyleAutoclear" id="fsEl_1153" data-use-new="true">
                ...
                <div class=" fsDiv fsStyleTwoThirds fsStyleAutoclear" id="fsEl_1154">
                  <div class="fsElement fsContent" id="fsEl_1155" data-use-new="true">
                    <header>
                      <h2 class="fsElementTitle">NURTURING ENVIRONMENT</h2>
                    </header>
                    <div class="fsElementContent">
                      <div class="WordSection1">
                        <p>
                          <strong style="color: rgb(192, 80, 77); text-transform: capitalize;"><span style="font-size: 20px;">Nothing is more important than providing a safe, nurturing environment. </span></strong>
                        </p>
                        <p>
                          <strong style="color: rgb(192, 80, 77); text-transform: capitalize;"><span style="font-size: 18px;">HAPPINESS ALL AROUND </span></strong>
                        </p>
                        ...
                        <p>
                          <strong style="color: rgb(192, 80, 77); text-transform: capitalize;"><span style="font-size: 18px;">SAFETY IS OUR TOP PRIORITY </span></strong>
                        </p>
                        <p>Nothing is more important than the health and safety of the children, and we consider their security in everything we do. From every detail of our classrooms and playgrounds, including our high standards of cleanliness and our state-of-the-art biometric finger and hand scanners for secure entry, we’ve tried to think of everything to keep your child safe and secure. </p>
                        <p>Highly trained standards representatives visit each Centre once a week to assess its compliance with our corporate tie ups health and safety standards. They also provide guidance to help each School continually improve for the children and their families, ensuring the highest-quality facility and program.</p>
                      </div>
                    </div>
                  </div>
                </div>
