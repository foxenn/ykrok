          ...
          <div class=" fsBanner fsStyleAutoclear" id="fsEl_7">
            ...
            <section class="fsElement fsContainer inner-logo-multimedia" id="fsEl_1964" data-use-new="true">
              ...
              <div class="fsElementContent">
                ...
                <div class="fsElement fsContent header-multimedia-holder" id="fsEl_1966" data-use-new="true" data-manual-resource-scaling="true" style="background-image: url('images/three.jpg');">
                  <div class="fsElementContent">
                  </div>
                </div>
              </div>
                  ...
                  <div class="fsElementContent">
                    <nav>
                      <ul class="fsNavLevel1">
                        <li class="fsNavCurrentPage"><a href="contact-us.php">Contact Us</a></li>
                      </ul>
                    </nav>
                  </div>
                </section>
                  ...
                  <div class="fsElement fsContent" id="fsEl_1155" data-use-new="true">
                    ...
                    <div class="fsElementContent">
                      ...
                      <p>Bharat Kapoor <br>
                        ...
                        #73, Amrit Chambers, 4th floor <br>
